...
2. Po každom cykle aktualizuj tieto dokumenty (a `AGENTS.md`, ak treba). Ak sa mení obsah, štruktúra, CTA, kontakty, flow alebo source-of-truth hierarchia, aktualizuj aj root `README.md`.
